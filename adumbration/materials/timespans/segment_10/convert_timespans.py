...
from adumbration.materials.pitch import tap_pitch_handler
from adumbration.materials.score_structure.segment_10.rhythm_material_pattern import (
    rhythm_material_list,
)
from adumbration.materials.score_structure.segment_10.time_signatures import bounds
from adumbration.materials.timespans.segment_10.make_timespans import (
...
segment_10_rhythm_timespans = evans.timespan.make_split_list(
    rhythm_timespan_list, bounds
)

rhythm_commands = []
for span in segment_10_rhythm_timespans:
...
segment_10_pitch_timespans = pitch_timespan_list

pitch_commands = []
for span in segment_10_pitch_timespans:
...
segment_10_dynamic_timespans = dynamic_timespan_list

dynamic_commands = []
for span in segment_10_dynamic_timespans:
    command = evans.HandlerCommand(
        voice_name=span.voice_name,
        timespan=abjad.Timespan(span.start_offset, span.stop_offset),
        handler=span.handler,
