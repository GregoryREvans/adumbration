...
from adumbration.materials.score_structure.segment_07.time_signatures import bounds
...
voicewise_material = abjad.OrderedDict(
    [
        ("Voice 1", seg_7_pitch_handler_one),
        ("Voice 2", seg_7_pitch_handler_two),
        ("Voice 3", seg_7_pitch_handler_three),
        ("Voice 4", seg_7_pitch_handler_four),
    ]
)
