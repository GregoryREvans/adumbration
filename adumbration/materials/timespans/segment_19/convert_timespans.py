...
from adumbration.materials.score_structure.segment_19.rhythm_material_pattern import (
    rhythm_material_list,
)
from adumbration.materials.score_structure.segment_19.time_signatures import bounds
from adumbration.materials.timespans.segment_19.make_timespans import (
...
segment_19_rhythm_timespans = evans.timespan.make_split_list(
    rhythm_timespan_list, bounds
)

rhythm_commands = []
for span in segment_19_rhythm_timespans:
