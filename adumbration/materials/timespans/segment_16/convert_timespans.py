...
from adumbration.materials.score_structure.segment_16.rhythm_material_pattern import (
    rhythm_material_list,
)
from adumbration.materials.score_structure.segment_16.time_signatures import bounds
from adumbration.materials.timespans.segment_16.make_timespans import (
...
segment_16_rhythm_timespans = evans.timespan.make_split_list(
    rhythm_timespan_list, bounds
)

rhythm_commands = []
for span in segment_16_rhythm_timespans:
