...
from adumbration.materials.pitch import (
    seg_5_pitch_handler_four,
    seg_5_pitch_handler_one,
    seg_5_pitch_handler_three,
    seg_5_pitch_handler_two,
)
from adumbration.materials.score_structure.segment_05.rhythm_material_pattern import (
    rhythm_material_list,
)
from adumbration.materials.score_structure.segment_05.time_signatures import bounds
...
voicewise_material = abjad.OrderedDict(
    [
        ("Voice 1", seg_5_pitch_handler_one),
        ("Voice 2", seg_5_pitch_handler_two),
        ("Voice 3", seg_5_pitch_handler_three),
        ("Voice 4", seg_5_pitch_handler_four),
    ]
)
