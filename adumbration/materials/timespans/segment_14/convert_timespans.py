...
from adumbration.materials.score_structure.segment_14.rhythm_material_pattern import (
    rhythm_material_list,
)
from adumbration.materials.score_structure.segment_14.time_signatures import bounds
...
segment_14_rhythm_timespans = evans.timespan.make_split_list(
    rhythm_timespan_list, bounds
)

rhythm_commands = []
for span in segment_14_rhythm_timespans:
