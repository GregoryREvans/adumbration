...
from adumbration.materials.score_structure.segment_20.rhythm_material_pattern import (
    rhythm_material_list,
)
from adumbration.materials.score_structure.segment_20.time_signatures import bounds
from adumbration.materials.timespans.segment_20.make_timespans import (
...
segment_20_rhythm_timespans = evans.timespan.make_split_list(
    rhythm_timespan_list, bounds
)

rhythm_commands = []
for span in segment_20_rhythm_timespans:
