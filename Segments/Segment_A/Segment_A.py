...
score = abjad.Score([
    ...
    abjad.StaffGroup(
        [
            abjad.Staff([abjad.Voice(name='Voice 1')],name='violin_string_staff', lilypond_type='StringStaff',),
            abjad.Staff([abjad.Voice(name='Voice 2')],name='violin_bow_staff', lilypond_type='BowStaff',),
            abjad.Staff([abjad.Voice(name='Voice 3')],name='violin_beam_staff', lilypond_type='BeamStaff',),
            abjad.Staff([abjad.Voice(name='Voice 4')],name='violin_lh_staff', lilypond_type='Staff',),
        ],
        name='violin',
    ),
    ...
    abjad.StaffGroup(
        [
            abjad.Staff([abjad.Voice(name='Voice 5')],name='viola_string_staff', lilypond_type='StringStaff',),
            abjad.Staff([abjad.Voice(name='Voice 6')],name='viola_bow_staff', lilypond_type='BowStaff',),
            abjad.Staff([abjad.Voice(name='Voice 7')],name='viola_beam_staff', lilypond_type='BeamStaff',),
            abjad.Staff([abjad.Voice(name='Voice 8')],name='viola_lh_staff', lilypond_type='Staff',),
        ],
        name='viola',
    ),
    ...
    abjad.StaffGroup(
        [
            abjad.Staff([abjad.Voice(name='Voice 9')],name='cello_string_staff', lilypond_type='StringStaff',),
            abjad.Staff([abjad.Voice(name='Voice 10')],name='cello_bow_staff', lilypond_type='BowStaff',),
            abjad.Staff([abjad.Voice(name='Voice 11')],name='cello_beam_staff', lilypond_type='BeamStaff',),
            abjad.Staff([abjad.Voice(name='Voice 12')],name='cello_lh_staff', lilypond_type='Staff',),
        ],
        name='cello',
    )
],
...
score_file = abjad.LilyPondFile.new(
    score,
    includes=['internal_stylesheet.ily', '/Users/evansdsg2/abjad/docs/source/_stylesheets/abjad.ily'],
    )
