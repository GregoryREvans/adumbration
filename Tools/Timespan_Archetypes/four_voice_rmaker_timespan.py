...
voice_1_timespan_list = abjad.TimespanList(
    [
        ...
        abjad.AnnotatedTimespan(
            start_offset=(28, 4), stop_offset=(31, 4), annotation=rmaker_two
        ),
        # abjad.AnnotatedTimespan(start_offset=(31, 4), stop_offset=(33, 4), annotation=None),
        abjad.AnnotatedTimespan(
            start_offset=(33, 4), stop_offset=(36, 4), annotation=rmaker_two
        ),
        # abjad.AnnotatedTimespan(start_offset=(36, 4), stop_offset=(40, 4), annotation=None),
        abjad.AnnotatedTimespan(
            start_offset=(40, 4), stop_offset=(43, 4), annotation=rmaker_one
        ),
        # abjad.AnnotatedTimespan(start_offset=(43, 4), stop_offset=(45, 4), annotation=None),
        abjad.AnnotatedTimespan(
            start_offset=(45, 4), stop_offset=(48, 4), annotation=rmaker_two
        ),
    ]
)
...
voice_2_timespan_list = abjad.TimespanList(
    [
        abjad.AnnotatedTimespan(
            start_offset=0, stop_offset=(4, 4), annotation=silence_maker
        ),
        abjad.AnnotatedTimespan(
            start_offset=(4, 4), stop_offset=(7, 4), annotation=rmaker_two
        ),
        # abjad.AnnotatedTimespan(start_offset=(7, 4), stop_offset=(9, 4), annotation='None'),
        abjad.AnnotatedTimespan(
            start_offset=(9, 4), stop_offset=(12, 4), annotation=rmaker_one
        ),
        # abjad.AnnotatedTimespan(start_offset=(12, 4), stop_offset=(16, 4), annotation='None'),
        abjad.AnnotatedTimespan(
            start_offset=(16, 4), stop_offset=(19, 4), annotation=rmaker_two
        ),
        # abjad.AnnotatedTimespan(start_offset=(19, 4), stop_offset=(21, 4), annotation='None'),
        abjad.AnnotatedTimespan(
            start_offset=(21, 4), stop_offset=(24, 4), annotation=rmaker_one
        ),
        abjad.AnnotatedTimespan(
            start_offset=(24, 4), stop_offset=(27, 4), annotation=rmaker_one
        ),
        # abjad.AnnotatedTimespan(start_offset=(27, 4), stop_offset=(29, 4), annotation='None'),
        abjad.AnnotatedTimespan(
            start_offset=(29, 4), stop_offset=(32, 4), annotation=rmaker_two
        ),
        # abjad.AnnotatedTimespan(start_offset=(32, 4), stop_offset=(36, 4), annotation='None'),
        abjad.AnnotatedTimespan(
            start_offset=(36, 4), stop_offset=(39, 4), annotation=rmaker_one
        ),
        # abjad.AnnotatedTimespan(start_offset=(39, 4), stop_offset=(41, 4), annotation='None'),
        abjad.AnnotatedTimespan(
            start_offset=(41, 4), stop_offset=(44, 4), annotation=rmaker_two
        ),
        abjad.AnnotatedTimespan(
            start_offset=(44, 4), stop_offset=(48, 4), annotation=silence_maker
        ),
    ]
)
...
voice_3_timespan_list = abjad.TimespanList(
    [
        abjad.AnnotatedTimespan(
            start_offset=0, stop_offset=(2, 4), annotation=silence_maker
        ),
        abjad.AnnotatedTimespan(
            start_offset=(2, 4), stop_offset=(5, 4), annotation=rmaker_one
        ),
        # abjad.AnnotatedTimespan(start_offset=(5, 4), stop_offset=(9, 4), annotation='None'),
        abjad.AnnotatedTimespan(
            start_offset=(9, 4), stop_offset=(12, 4), annotation=rmaker_two
        ),
        # abjad.AnnotatedTimespan(start_offset=(12, 4), stop_offset=(14, 4), annotation='None'),
        abjad.AnnotatedTimespan(
            start_offset=(14, 4), stop_offset=(17, 4), annotation=rmaker_two
        ),
        ...
        abjad.AnnotatedTimespan(
            start_offset=(24, 4), stop_offset=(27, 4), annotation=rmaker_two
        ),
        # abjad.AnnotatedTimespan(start_offset=(27, 4), stop_offset=(31, 4), annotation='None'),
        abjad.AnnotatedTimespan(
            start_offset=(31, 4), stop_offset=(34, 4), annotation=rmaker_one
        ),
        ...
        abjad.AnnotatedTimespan(
            start_offset=(43, 4), stop_offset=(46, 4), annotation=rmaker_two
        ),
        abjad.AnnotatedTimespan(
            start_offset=(46, 4), stop_offset=(48, 4), annotation=silence_maker
        ),
    ]
)
...
voice_4_timespan_list = abjad.TimespanList(
    [
        ...
        abjad.AnnotatedTimespan(
            start_offset=(25, 4), stop_offset=(29, 4), annotation=rmaker_one
        ),
        # abjad.AnnotatedTimespan(start_offset=(29, 4), stop_offset=(33, 4), annotation=None),
        abjad.AnnotatedTimespan(
            start_offset=(33, 4), stop_offset=(36, 4), annotation=rmaker_one
        ),
        # abjad.AnnotatedTimespan(start_offset=(36, 4), stop_offset=(38, 4), annotation=None),
        abjad.AnnotatedTimespan(
            start_offset=(38, 4), stop_offset=(41, 4), annotation=rmaker_two
        ),
        # abjad.AnnotatedTimespan(start_offset=(41, 4), stop_offset=(45, 4), annotation=None),
        abjad.AnnotatedTimespan(
            start_offset=(45, 4), stop_offset=(48, 4), annotation=rmaker_one
        ),
    ]
)
