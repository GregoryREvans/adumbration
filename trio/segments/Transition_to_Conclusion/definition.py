...
time_signature_staff_1 = abjad.Staff(
    lilypond_type="TimeSignatureContext", name="TimeSignatureContext1"
)
time_signature_staff_2 = abjad.Staff(
    lilypond_type="TimeSignatureContext", name="TimeSignatureContext2"
)
...
violin_bow_staff = abjad.Staff(lilypond_type="BowStaff", name="violin_bow_staff")
...
violin_lh_maker_1 = NoteMusicMaker(
    mask_indices=[4], mask_period=5, pitches=violin_notes_1, beams=False
)
...
viola_lh_maker_1 = NoteMusicMaker(
    mask_indices=[3], mask_period=4, pitches=viola_notes_1, beams=False
)
...
cello_lh_maker_1 = NoteMusicMaker(
    mask_indices=[1], mask_period=5, pitches=cello_notes_1, beams=False
)
...
viola_lh_maker_2 = NoteMusicMaker(
    mask_indices=[1], mask_period=3, pitches=viola_notes_2, beams=False
)
...
violin_lh_maker_3 = NoteMusicMaker(
    mask_indices=[2], mask_period=6, pitches=violin_notes_3, beams=False
)
...
viola_lh_maker_3 = NoteMusicMaker(
    mask_indices=[1], mask_period=5, pitches=viola_notes_3, beams=False
)
...
cello_lh_maker_3 = NoteMusicMaker(
    mask_indices=[0], mask_period=2, pitches=cello_notes_3, beams=False
)
...
violin_lh_maker_4 = NoteMusicMaker(
    mask_indices=[2], mask_period=6, pitches=violin_notes_4, beams=False
)
...
viola_lh_maker_4 = NoteMusicMaker(
    mask_indices=[1], mask_period=3, pitches=viola_notes_4, beams=False
)
...
cello_lh_maker_4 = NoteMusicMaker(
    mask_indices=[-1], mask_period=4, pitches=cello_notes_4, beams=False
)
...
violin_lh_maker_5 = NoteMusicMaker(
    mask_indices=[2], mask_period=5, pitches=violin_notes_5, beams=False
)
...
viola_lh_maker_5 = NoteMusicMaker(
    mask_indices=[2], mask_period=5, pitches=viola_notes_5, beams=False
)
...
cello_lh_maker_5 = NoteMusicMaker(
    mask_indices=[2], mask_period=5, pitches=cello_notes_5, beams=False
)
...
for music_maker in [violin_bow_maker_2]:
    music = music_maker.make_music(violin_time_signature_pairs_2)
    violin_bow_staff.append(music[:])

for music_maker in [violin_bow_maker_3]:
    music = music_maker.make_music(violin_time_signature_pairs_3)
    violin_bow_staff.append(music[:])

for music_maker in [violin_bow_maker_4]:
    music = music_maker.make_music(violin_time_signature_pairs_4)
    violin_bow_staff.append(music[:])
...
for music_maker in [violin_bow_beam_maker_2]:
    music = music_maker.make_music(violin_time_signature_pairs_2)
    violin_bow_beam_staff.append(music[:])

for music_maker in [violin_bow_beam_maker_3]:
    music = music_maker.make_music(violin_time_signature_pairs_3)
    violin_bow_beam_staff.append(music[:])

for music_maker in [violin_bow_beam_maker_4]:
    music = music_maker.make_music(violin_time_signature_pairs_4)
    violin_bow_beam_staff.append(music[:])

for music_maker in [violin_bow_beam_maker_5]:
    music = music_maker.make_music(violin_time_signature_pairs_5)
    violin_bow_beam_staff.append(music[:])
...
for music_maker in [violin_lh_maker_2]:
    music = music_maker.make_music(violin_time_signature_pairs_2)
    violin_lh_staff.append(music[:])

for music_maker in [violin_lh_maker_3]:
    music = music_maker.make_music(violin_time_signature_pairs_3)
    violin_lh_staff.append(music[:])

for music_maker in [violin_lh_maker_4]:
    music = music_maker.make_music(violin_time_signature_pairs_4)
    violin_lh_staff.append(music[:])

for music_maker in [violin_lh_maker_5]:
    music = music_maker.make_music(violin_time_signature_pairs_5)
    violin_lh_staff.append(music[:])
...
for music_maker in [viola_bow_maker_2]:
    music = music_maker.make_music(viola_time_signature_pairs_2)
    viola_bow_staff.append(music[:])

for music_maker in [viola_bow_maker_3]:
    music = music_maker.make_music(viola_time_signature_pairs_3)
    viola_bow_staff.append(music[:])

for music_maker in [viola_bow_maker_4]:
    music = music_maker.make_music(viola_time_signature_pairs_4)
    viola_bow_staff.append(music[:])
...
for music_maker in [viola_bow_beam_maker_2]:
    music = music_maker.make_music(viola_time_signature_pairs_2)
    viola_bow_beam_staff.append(music[:])

for music_maker in [viola_bow_beam_maker_3]:
    music = music_maker.make_music(viola_time_signature_pairs_3)
    viola_bow_beam_staff.append(music[:])

for music_maker in [viola_bow_beam_maker_4]:
    music = music_maker.make_music(viola_time_signature_pairs_4)
    viola_bow_beam_staff.append(music[:])

for music_maker in [viola_bow_beam_maker_5]:
    music = music_maker.make_music(viola_time_signature_pairs_5)
    viola_bow_beam_staff.append(music[:])
...
for music_maker in [viola_lh_maker_2]:
    music = music_maker.make_music(viola_time_signature_pairs_2)
    viola_lh_staff.append(music[:])

for music_maker in [viola_lh_maker_3]:
    music = music_maker.make_music(viola_time_signature_pairs_3)
    viola_lh_staff.append(music[:])

for music_maker in [viola_lh_maker_4]:
    music = music_maker.make_music(viola_time_signature_pairs_4)
    viola_lh_staff.append(music[:])

for music_maker in [viola_lh_maker_5]:
    music = music_maker.make_music(viola_time_signature_pairs_5)
    viola_lh_staff.append(music[:])
...
for music_maker in [cello_bow_maker_2]:
    music = music_maker.make_music(cello_time_signature_pairs_2)
    cello_bow_staff.append(music[:])

for music_maker in [cello_bow_maker_3]:
    music = music_maker.make_music(cello_time_signature_pairs_3)
    cello_bow_staff.append(music[:])

for music_maker in [cello_bow_maker_4]:
    music = music_maker.make_music(cello_time_signature_pairs_4)
    cello_bow_staff.append(music[:])
...
for music_maker in [cello_bow_beam_maker_2]:
    music = music_maker.make_music(cello_time_signature_pairs_2)
    cello_bow_beam_staff.append(music[:])

for music_maker in [cello_bow_beam_maker_3]:
    music = music_maker.make_music(cello_time_signature_pairs_3)
    cello_bow_beam_staff.append(music[:])

for music_maker in [cello_bow_beam_maker_4]:
    music = music_maker.make_music(cello_time_signature_pairs_4)
    cello_bow_beam_staff.append(music[:])

for music_maker in [cello_bow_beam_maker_5]:
    music = music_maker.make_music(cello_time_signature_pairs_5)
    cello_bow_beam_staff.append(music[:])
...
for music_maker in [cello_lh_maker_2]:
    music = music_maker.make_music(cello_time_signature_pairs_2)
    cello_lh_staff.append(music[:])

for music_maker in [cello_lh_maker_3]:
    music = music_maker.make_music(cello_time_signature_pairs_3)
    cello_lh_staff.append(music[:])

for music_maker in [cello_lh_maker_4]:
    music = music_maker.make_music(cello_time_signature_pairs_4)
    cello_lh_staff.append(music[:])

for music_maker in [cello_lh_maker_5]:
    music = music_maker.make_music(cello_time_signature_pairs_5)
    cello_lh_staff.append(music[:])
...
_apply_string_numerators_and_tech(
    staff=viola_string_staff, nums=viola_string_nums, tech=string_tech
)
_apply_string_numerators_and_tech(
    staff=cello_string_staff, nums=cello_string_nums, tech=string_tech
)

_apply_bow_numerators_and_tech(
    staff=violin_bow_staff, nums=violin_bow_nums, tech=violin_bow_tech
)
_apply_bow_numerators_and_tech(
    staff=viola_bow_staff, nums=viola_bow_nums, tech=viola_bow_tech
)
_apply_bow_numerators_and_tech(
...
violin_staff.extend(
    [violin_string_staff, violin_bow_staff, violin_bow_beam_staff, violin_lh_staff]
)

viola_staff = abjad.StaffGroup(lilypond_type="StaffGroup", name="viola")
viola_staff.extend(
    [viola_string_staff, viola_bow_staff, viola_bow_beam_staff, viola_lh_staff]
)
...
score.extend(
    [
        time_signature_staff_1,
        violin_staff,
        time_signature_staff_2,
        viola_staff,
        time_signature_staff_3,
        cello_staff,
    ]
)
...
directory = "/Users/evansdsg2/Scores/trio/Segments/Transition_to_Conclusion"
