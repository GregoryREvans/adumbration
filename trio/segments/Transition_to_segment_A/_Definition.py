...
violin_string_staff_leaves = abjad.select(violin_string_staff).leaves()
...
violin_bow_staff_leaves = abjad.select(violin_bow_staff).leaves()
...
viola_string_staff_leaves = abjad.select(viola_string_staff).leaves()
...
viola_bow_staff_leaves = abjad.select(viola_bow_staff).leaves()
...
cello_string_staff_leaves = abjad.select(cello_string_staff).leaves()
...
cello_bow_staff_leaves = abjad.select(cello_bow_staff).leaves()
