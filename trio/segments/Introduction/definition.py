...
violin_staff = abjad.StaffGroup(
    ...
    name="violin",
    # tag='introduction-violin-staffgroup',
)
violin_staff.extend(
    [violin_string_staff, violin_bow_staff, violin_bow_beam_staff, violin_lh_staff]
)

viola_staff = abjad.StaffGroup(
    lilypond_type="StaffGroup",
    name="viola",
    # tag='introduction-viola-staffgroup',
)
viola_staff.extend(
    [viola_string_staff, viola_bow_staff, viola_bow_beam_staff, viola_lh_staff]
)

cello_staff = abjad.StaffGroup(
    lilypond_type="StaffGroup",
    name="cello",
    # tag='introduction-cello-staffgroup',
)
cello_staff.extend(
